    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-8 py-8 sm:py-12 space-y-10">
      ...
      <article className="space-y-6">
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 sm:p-8 max-w-4xl mx-auto shadow-2xs">
          <p className="text-base sm:text-lg text-slate-700 leading-relaxed font-medium text-justify sm:text-center">
            {isVi
          ...
          <div className="mt-5 flex flex-wrap items-center justify-center gap-3 text-xs sm:text-sm font-bold text-slate-700">
            <span className="flex items-center gap-1.5 bg-white px-3.5 py-2 rounded-xl border border-slate-200 shadow-2xs">
        ...
        <div className="pt-2 flex flex-col items-center justify-center text-center space-y-3 max-w-2xl mx-auto">
          ...
          <p className="text-xs sm:text-sm text-slate-500 font-medium flex items-center justify-center gap-1.5">
      ...
      <section className="bg-white rounded-3xl shadow-xl border border-slate-200 p-6 sm:p-10 space-y-8">
        <div className="text-center max-w-2xl mx-auto space-y-2">
          <div className="inline-flex items-center gap-1.5 bg-slate-100 text-slate-700 text-xs font-extrabold px-3 py-1.5 rounded-full uppercase tracking-wider">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="bg-slate-900 text-white rounded-3xl p-6 sm:p-8 shadow-xl space-y-5 border border-slate-800">
            <div className="space-y-2">
              <div className="inline-flex items-center gap-1.5 bg-indigo-500/20 text-indigo-300 text-xs font-extrabold px-3 py-1 rounded-full border border-indigo-500/30">
            ...
            <a
              ...
              target="_blank"
              rel="nofollow"
              className="w-full bg-orange-600 hover:bg-orange-700 active:bg-orange-800 text-white font-extrabold text-sm sm:text-base py-3.5 px-6 rounded-2xl shadow-lg transition-all flex items-center justify-center gap-2 cursor-pointer border border-orange-500"
            >
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-3xl p-6 space-y-3">
            ...
            <div className="pt-1">
              <a
                ...
                className="inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs sm:text-sm px-4 py-2.5 rounded-xl shadow transition-colors"
              >
